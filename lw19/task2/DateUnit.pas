...
INTERFACE
  ...
  PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Month); { Çàïèñü ìåñÿöà â ôàéë }
  PROCEDURE WriteDate(VAR FOut: TEXT; VAR Result: Date); { Çàïèñü äàòû â ôàéë }
  PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month); { ×òåíèå ìåñÿöà èç ôàéëà }
  PROCEDURE ReadDate(VAR FIn: TEXT; VAR Result: Date); { ×òåíèå äíÿ èç ôàéëà }
  FUNCTION Less(VAR D1, D2: Date): BOOLEAN; { Ñðàâíåíèå 2-õ äàò }
  PROCEDURE CopyOut(VAR DateFile: FileOfDate); { Âûâîä äàòû èç ôàéëà â OUTPUT }
